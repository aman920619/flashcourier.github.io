<?php
  ...
  $q=mysqli_query($con,"select * from tbl_cus_parcel") or die(mysqli_error($con));
...
<head>
  ...
  <title>Flash Courier | Item Accepted by Courier</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h1><span style="color:#ffffff"><b>PARCEL ACCEPTED</b></h1>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Item Accepted by Courier</h3>
              </div>
              <div class="card-body">
