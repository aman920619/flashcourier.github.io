...
<head>
  ...
  <title>Flash Courier | Parcel List</title>
...
<body class="hold- dark-mode sidebar-mini">
<div class="wrapper">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      $parlis=mysqli_query($con,"select * from tbl_cus_parcel") or die(mysqli_error($con));
                      while($parl=mysqli_fetch_array($parlis)):
                      ?>
                    <tr>
						<td class="text-center"><?php echo ($parl['cus_id'])?></td>
						<td><b><?php echo ($parl['order_id']) ?></b></td>
						<td><b><?php echo ucwords($parl['sender_name']) ?></b></td>
						<td><b><?php echo ucwords($parl['rec_name']) ?></b></td>
						<td class="text-center">
							...
							switch ($parl['status']) {
								...
								case '6':
									...
									break;
								case '7':
									echo "<span class='badge badge-pill badge-success'>Ready to Pick-up</span>";
									break;
								case '8':
            ...
            <td>
              <form action="parcel_list.php" method="post">
                ...
                <input type='hidden' name='cus_id' value='<?php echo $parl['cus_id'];?>'/>
              </form>
						...
						<td class="text-center">
                            ...
                            <a href="delete.php?id=<?php echo $parl['cus_id']; ?>" class=" ">
